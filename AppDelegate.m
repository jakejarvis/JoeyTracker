...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	UIViewController *viewController1 = [[ETAViewController alloc] initWithNibName:@"ETAViewController" bundle:nil];
	UIViewController *viewController2 = [[MapViewController alloc] initWithNibName:@"MapViewController" bundle:nil];
	UIViewController *viewController3 = [[ScheduleViewController alloc] initWithNibName:@"ScheduleViewController" bundle:nil];
	UIViewController *viewController4 = [[HelpViewController alloc] initWithNibName:@"HelpViewController" bundle:nil];
