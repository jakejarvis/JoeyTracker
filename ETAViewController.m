...
@synthesize leftbg, davisbg, ccfrontbg, carmbg, olinbg, ccrearbg, bground1, bground2, bground3, bground4, davis, ccFront, ccRear, olin, carm, round1, round2, round3, round4, round5, lastRefreshed, navbar, navbarrefresh;
...
- (void)loadETAs
{
    __block Boolean finished = NO;
    __block NSString *lastUpdatedText;
    ...
    dispatch_async(dispatch_queue_create("com.jakejarvis.joeytracker.ETA",NULL),^{
        ...
        TBXMLSuccessBlock successBlock = ^(TBXML *tbxmlDocument) {
            ...
            do {
                ...
                if(stop_id == 1) daviseta = [[NSString stringWithString:eta] retain];
                else if(stop_id == 2) ccReareta = [[NSString stringWithString:eta] retain];
                else if(stop_id == 3) carmeta = [[NSString stringWithString:eta] retain];
                else if(stop_id == 4) olineta = [[NSString stringWithString:eta] retain];
                else if(stop_id == 5) ccFronteta = [[NSString stringWithString:eta] retain];
            ...
            lastUpdatedText = [[NSString stringWithFormat:@"Last updated at %@.", currentTime] retain];
        ...
        dispatch_sync(dispatch_get_main_queue(),^{
            ...
            //timeLastUpdated = [[NSNumber numberWithLongLong:[[NSDate date] timeIntervalSince1970] * 1000] retain];
